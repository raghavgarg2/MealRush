...
//           className="bg-gray-50 shadow-lg p-6 rounded-xl flex justify-between items-center"
//         >
//           <div className="w-3/4">
...
//               className="absolute left-0 bottom-0 bg-black text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-gray-800 transition duration-200"
//             >
//               Add+
//             </button>
//             <button
//               onClick={() => handleRemove(item)}
//               className="absolute left-0 bottom-10 bg-red-600 text-white px-4 py-2 rounded-md text-sm font-semibold hover:bg-red-500 transition duration-200"
//             >
//               Remove
//             </button>
//             <img
